      ...
      <main className="flex-1 flex flex-col justify-center p-4 md:p-6 pb-28 lg:pb-6 animate-fade-in relative z-10">
        <div className="mx-auto flex w-full max-w-4xl flex-col gap-6">
          <header className="rounded-3xl border border-border/60 bg-surface/80 backdrop-blur-md p-8 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)] relative overflow-hidden text-center md:text-left">
            ...
            <p className="m-0 text-xs font-bold uppercase tracking-widest text-accent drop-shadow-[0_0_8px_rgba(245,158,11,0.5)]">Loudness coach</p>
            ...
            {presets.map((preset, i) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <p className="m-0 text-xl font-bold text-text group-hover:text-accent transition-colors">{preset.label}</p>
                  <p className="m-0 mt-2 text-sm leading-relaxed text-text-muted flex-1">{preset.description}</p>
